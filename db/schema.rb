...
ActiveRecord::Schema.define(version: 2020_09_22_212700) do
  ...
  create_table "socials", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["provider"], name: "index_socials_on_provider"
    t.index ["uid"], name: "index_socials_on_uid"
    t.index ["user_id", "provider", "uid"], name: "index_socials_on_user_id_and_provider_and_uid", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "has_local_password", default: true, null: false
